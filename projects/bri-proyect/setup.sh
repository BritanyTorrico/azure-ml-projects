...
az ml compute create --name ${COMPUTE_CLUSTER} --size Standard_E4as_v4 --max-instances 1 --type AmlCompute 

# Create data assets
echo "Create training data asset:"
az ml data create --type uri_file --name "obesity-data" --path ./data/obesity.csv 